...
-- Script date 29/11/2021 20:56:33
...
FROM ((((`tasks`
  ...
  LEFT JOIN `categories_tasks`
    ON ((`categories_tasks`.`task_id` = `tasks`.`id`)))
  LEFT JOIN `categories`
    ON (((`categories`.`category_user` = `users`.`id`)
    AND (`categories_tasks`.`category_id` = `categories`.`id`))));
...
(66, 'fabio2@lopes.dev', 'Fabio Lopes', '1234567', '2021-11-21 19:39:17', '2021-11-29 23:51:38'),
(67, 'fabio3@lopes.dev', 'Fabio Lopes', '1234568', '2021-11-21 19:39:36', '2021-11-29 23:51:43'),
(68, 'fabio4@lopes.dev', 'Fabio Lopes', '1234569', '2021-11-21 20:57:14', '2021-11-29 23:51:46');
...
(1, 'Qualquer coisa2', NULL, 2, 66, '2021-11-21 22:38:13', '2021-11-21 22:42:41', NULL),
(2, 'Qualquer coisa', NULL, 2, 66, '2021-11-21 22:40:01', '2021-11-29 23:26:16', NULL),
(3, 'Qualquer coisa', NULL, 1, 65, '2021-11-28 18:02:10', '2021-11-28 18:02:10', NULL),
(4, 'Qualquer coisa', NULL, 1, 66, '2021-11-29 23:17:58', '2021-11-29 23:26:11', NULL),
(5, 'Qualquer coisa', NULL, 1, 66, '2021-11-29 23:18:54', '2021-11-29 23:26:08', NULL),
(6, 'Qualquer coisa', NULL, 1, 65, '2021-11-29 23:23:37', '2021-11-29 23:23:37', NULL);
